...
class BotConfig:
    ...
    def __init__(self):
        ...
        self.cogs = ["cogs.greet","cogs.sticky","cogs.autoresponder",cogs.status_changer","cogs.dragmee","cogs.AvatarBannerUpdater","cogs.giveaway","cogs.steal","cogs.stats","cogs.afk_cog","cogs.purge","cogs.key_generator","cogs.av","cogs.thread","cogs.sticky","cogs.reqrole","cogs.confess"]
        self.log_dir = "logs"
